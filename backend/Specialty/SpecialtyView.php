...
<html>
<head>
	<title><?php echo $specialty["title"]; ?></title>
...
<?php include_once(DIRNAME.'view/template/header.php'); ?>
	...
	<div class="row">
	    ...
	    <div class="col-sm-9">
     		...
     		<h3 style="float:left"><?php echo $specialty["title"]; ?></h3>
	        ...
	        <div class="caption">
		        <form method="POST" class="form vertical-form">
		            <div class="form-group">
		            	<input type="text" class="form-control" name="title" placeholder="Title" value="<?php echo $specialty["title"]; ?>" required/>
		            </div>
		            
		       
		            <div class="form-group">
		            	<button type="submit" class="form-control" name="specialty_update">Обновить</button>
		        	</div>
		        </form>
            </div>
