...
<?php include_once(DIRNAME.'view/template/header.php'); ?>
	...
	<div class="row">
	    ...
	    <div class="col-sm-9">
     		...
     		<h3 style="float:left">Список груп</h3>
		     	...
		     	<?php foreach($groups as $get): ?>
	                <tr>
	                	...
	                	<td>
	                 	...
	                 	<td>
	                 		<a href="<?php uri(); ?>admin/group/<?php echo $get["id"]; ?>" class="btn btn-info">Обновить</a>
	                 	</td>
	                 	<td>
	                 		<a href="<?php uri(); ?>admin/group/delete/<?php echo $get["id"]; ?>" class="btn btn-warning">Удалить</a>
	                 	</td>
	                </tr>
		     	<?php endforeach; ?>
		     	</tbody>
