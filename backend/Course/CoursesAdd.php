...
<?php include_once(DIRNAME.'view/template/header.php'); ?>
	...
	<div class="row">
	    ...
	    <div class="col-sm-9">
     		...
     		<h3 style="float:left">Добавить Курс</h3>
	        ...
	        <div class="caption">
		        <form method="POST" class="form vertical-form">
		            ...
		            <div class="form-group">
		               <select  class="form-control" name="specialty_id" placeholder="Specialty" required>
		                   <?php foreach($specialty as $get): ?>
		            ...
		            <div class="form-group">
		            	<button type="submit" class="form-control" name="course_add">Добавить</button>
		        	</div>
		        </form>
            </div>
