...
<?php include_once(DIRNAME.'view/template/header.php'); ?>
	...
	<div class="row">
	    ...
	    <div class="col-sm-9">
     		...
     		<h3 style="float:left">Добавить ранк</h3>
	        ...
	        <div class="caption">
		        <form method="POST" class="form vertical-form">
		            ...
		            <div class="form-group">
		            	<input type="text" class="form-control" name="max_student" placeholder="Max student num" required/>
		            </div>
		            
		            <div class="form-group">
		            	<button type="submit" class="form-control" name="rank_add">Добавить</button>
		        	</div>
		        </form>
            </div>
