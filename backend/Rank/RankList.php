...
<?php include_once(DIRNAME.'view/template/header.php'); ?>
	...
	<div class="row">
	    ...
	    <div class="col-sm-9">
     		...
     		<h3 style="float:left">Список ранков</h3>
		     	...
		     	<?php foreach($ranks as $get): ?>
	                <tr>
	                	...
	                	<td>
	                 	...
	                 	<td>
	                 		<a href="<?php uri(); ?>admin/rank/<?php echo $get["id"]; ?>" class="btn btn-info">Обновить</a>
	                 	</td>
	                 	<td>
	                 		<a href="<?php uri(); ?>admin/rank/delete/<?php echo $get["id"]; ?>" class="btn btn-warning">Удалить</a>
	                 	</td>
	                </tr>
		     	<?php endforeach; ?>
		     	</tbody>
